...
const Hotel = () => {
  ...
  // const photos = [
  //   {
  //     src: "https://www.tajhotels.com/content/dam/luxury/tajbengal/gallery/LOBBY%20139%20MAIN.jpg/_jcr_content/renditions/cq5dam.web.756.756.jpeg",
  //   },
  //   {
  //     src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIBDffTFk0-zW7OiHNrcMquGiiPwtcHlkeUp8SznTnPD0AC_Fjt8zA8oyMOsp9m20vRd8&usqp=CAU",
  //   },
  //   {
            ...
            <div className="hotelWrapper">
              ...
              <div className="hotelDetails">
                ...
                <div className="hotelDetailsPrice">
                  ...
                  <h2>
                    <b>${days * data.cheepestPrice * options.room}</b> ({days}{" "}
                    nights)
                  </h2>
